...
struct FillingData {
    static let data: [ContentType] = [
        ...
        .gallery(Gallery(coverImage: .init("food-0"), title: "Food", images: .init(base: "food", count: 8))),
        ...
        .gallery(Gallery(coverImage: .init("book-0"), title: "Books", images: .init(base: "book", count: 6)))
